...
public class GameManager : MonoBehaviour
{
    ...
    public void NextPlayer()
    {
        ...
        {
            Camera.main.transform.position = new Vector3(0.12f, 4.48f, 6.26f);
            Camera.main.transform.Rotate(87.4f, -180.0f, 0);
        }
        else
        {
            Camera.main.transform.position = new Vector3(0.12f, 4.48f, -5.99f);
            Camera.main.transform.Rotate(87.4f, 180.0f, 0);
        }
